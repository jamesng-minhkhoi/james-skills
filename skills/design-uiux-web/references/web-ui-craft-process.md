...
Report the design artifact, route/states covered, content fixtures,
viewport/input matrix, screenshots or recordings, design decisions, data/
provider constraints, implementation questions, and unobserved engineering
gates. Automated checks belong to the engineering skill.
