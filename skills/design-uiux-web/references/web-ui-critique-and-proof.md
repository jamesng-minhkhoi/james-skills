...
and input methods. This is a design critique, not product QA. Source inspection
and tests support a review but do not replace rendered and interactive design
proof.
...
Report the design artifact, route/data assumptions, viewport/input/theme,
screenshots or recording, design checks, and unobserved provider/production/
analytics gates. Do not call product behavior complete because lint, typecheck,
or tests pass elsewhere.
