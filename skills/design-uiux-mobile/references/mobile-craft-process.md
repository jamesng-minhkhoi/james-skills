...
## Mobile design acceptance checklist
...
- The design artifact or prototype shows the intended route/flow and
  representative states, not only a polished default mock.
