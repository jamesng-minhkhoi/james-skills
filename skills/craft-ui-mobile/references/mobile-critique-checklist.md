...
Use after rendering the route in a simulator, device, or closest available
mobile harness. Source inspection and tests can support the review but cannot
replace rendered evidence.
...
9. **Motion/personality:** Do transitions clarify change and does personality
   support rather than compete with comprehension?
10. **Proof:** Are the important states and devices actually rendered and
    observed?
...
| Interaction | Pressed, focused, selected, disabled, keyboard, sheet, gesture |
...
- automated checks run and their scope;
- unresolved native, provider, production, analytics, or store gates;
- whether the change preserved business logic and data contracts.

Do not call the work visually complete because lint, typecheck, or tests pass.
Do not call a native or production gate complete without observing that gate.
